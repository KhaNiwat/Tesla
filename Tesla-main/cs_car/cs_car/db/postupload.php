...
if (isset($_SESSION['user_login'])) {
    ...
    if (isset($_POST['submit_post'])) {
        ...
        try {
            $sql = "INSERT INTO post (uid, Model,model_type,header,detail,color,year,price,status) VALUES (:uid, :model,:model_type, :post_header, :post_detail, :cars_color, :year, :price, :status)";
