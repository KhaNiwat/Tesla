...
<body>
    ...
    <div id="mobile">
        ...
        <div class="box5">
            ...
            <div class="submitbuy">
                <br>
                <input id="ADD_SUM" name='submitbuy' type="submit" value="Order" onclick="updateSoftwareField()">
            </div>
            <!-- ตรงนี้ -->
            </form>
            <br><br>
        ...
        animationInterval = setInterval(function() {
            if (animationValue < maxAnimationValue || animationValue2 < maxAnimationValue2) {
                if (animationValue < maxAnimationValue) {
                    ...
                    document.querySelector("#rangemo span").innerHTML = animationValue;
                }
                if (animationValue2 < maxAnimationValue2) {
                    animationValue2 += 0.1;
                    document.querySelector("#acc span").innerHTML = animationValue2.toFixed(1);
                    document.querySelector("#accmo span").innerHTML = animationValue2.toFixed(1);
