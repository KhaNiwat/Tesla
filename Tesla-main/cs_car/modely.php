...
<head>
    ...
    <title>Design Your Model Y</title>
...
<body>
    <div id="pc">
        ...
        <div class="container">
            <section class="left-section">
                <div class="pic">
                    <img src="image/ModelY/black/mdy-B-19-B-1.jpg" style="width:100%" id="image">
                    <div class="picbutton">
                        <button class="arrow-button" onclick="changepic(-1)">&#9664;</button>
                        <button class="arrow-button" onclick="changepic(1)">&#9654;</button>
                    </div>
                    <div class="footer">
                        <h3 id="price">฿1,699,900</h3>
                    </div>
                </div>
            </section>
            ...
            <section class="right-section">
                <br><br>
                <form action="./db/purchases_summary.php?modeltype=modely" method="post">
                    <div class="box1">
                        <h1>Model Y</h1>
                        <div class="spec_car">
                            <ol class="specbox">
                        ...
                        <div class="bt">
                            ...
                            <div class="bt2">
                                ...
                                <label>Model Y Long Range</label>
                            </div>
                            <div class="bt2">
                                <input type="radio" value="PFM" name="model" onchange="changeStatus(this.value)">
                                <label>Model Y Performance</label>
                            </div>
                        </div>
                    ...
                    <div class="box3">
                        ...
                        <div class="bt">
                            <div class="bt bt1">
                                <input type="radio" name="wheel" value="19" checked onchange="changeimage(document.querySelector('input[name=\'PAINT\']:checked').value, this.value, document.querySelector('input[name=\'interior\']:checked').value)">
                                <label>19’’ Photon Wheels</label><br>
                            </div>

                            <div class="bt bt2">
                                <input type="radio" name="wheel" value="20" onchange="changeimage(document.querySelector('input[name=\'PAINT\']:checked').value, this.value, document.querySelector('input[name=\'interior\']:checked').value)">
                                <label>20’’ Nova Wheels</label><br>
                            </div>
                    ...
                    <div class="box6">
                        ...
                        <div class="submitbuy">
                            <input id="ADD_SUM" name='submitbuy' type="submit" value="สั่งซื้อ" onclick="updateSoftwareField()">
                        </div>
                        <br><br>
                    </div>
                </form>
    ...
    <div id="mobile">
        <br>
        <img src="image/ModelY/black/mdy-B-19-B-1.jpg" style="width:100%" id="image1">
        <h3 id="pricemo">฿1,699,000</h3>
        <hr>
        <section class="right-section">
            <form action="./db/purchases_summary.php?modeltype=modely" method="post">
            <br><br>
            <div class="box1">
                ...
                <div class="specbox">
                    <div class="mini">
                        ...
                        <div class="bt2">
                            <input type="radio" value="LR" name="modelmo" onchange="changeStatus(this.value)">
                            <label>Model Y Long Range</label>
                        </div>
                        <div class="bt2">
                            <input type="radio" value="PFM" name="modelmo" onchange="changeStatus(this.value)">
                            <label>Model Y Performance</label>
                        </div>
                    </div>
                </div>
    ...
    <div class="box2">
        <img src="image/ModelY/black/mdy-B-19-B-2.jpg" style="width:100%" id="image2">
        <h1 id="paint">Color</h1>
        <div class="specbox">
    ...
    <div class="box3">
        <img src="image/ModelY/black/mdy-B-19-B-4.jpg" style="width:100%" id="image4">
        <h1>wheel</h1>
        <div class="specbox">
            <div class="mini">
                <input type="radio" name="wheelmo" value="19" checked onchange="changeimage(document.querySelector('input[name=\'PAINTmo\']:checked').value, this.value, document.querySelector('input[name=\'interiormo\']:checked').value)">
                <label>19’’ Photon Wheels</label><br>

                <input type="radio" name="wheelmo" value="20" onchange="changeimage(document.querySelector('input[name=\'PAINTmo\']:checked').value, this.value, document.querySelector('input[name=\'interiormo\']:checked').value)">
                <label>20’’ Nova Wheels</label>
            </div>
        </div>
    ...
    <hr>
    <div class="box4">
        <img src="image/ModelY/black/mdy-B-19-B-1.jpg" style="width:100%" id="image5">
        <h1> Interior </h1>
        <div class="specbox">
            <div class="mini">
...
<script>
    ...
    function changeStatus(selectedModel) {
        ...
        if (selectedModel === 'RWD') {
            animationValue = 400;
            maxAnimationValue = 455;
            animationValue2 = 0.0; // เริ่มค่า animationValue2 ที่ 0.0 สำหรับ 'RWD'
            maxAnimationValue2 = 6.9;
            document.querySelector("#range span").innerHTML = '455';
            document.querySelector("#top_speed span").innerHTML = '217';
            document.querySelector("#acc span").innerHTML = '6.9';
            document.querySelector("#acc span").nextElementSibling.innerHTML = 'วินาที';
            model = "RWD";

        } else if (selectedModel === 'LR') {
            animationValue = 455;
            maxAnimationValue = 533;
            animationValue2 = 0.0; // เริ่มค่า animationValue2 ที่ 0.0 สำหรับ 'RWD'
            maxAnimationValue2 = 5.0;
            document.querySelector("#range span").innerHTML = '533';
            document.querySelector("#top_speed span").innerHTML = '217';
            document.querySelector("#acc span").innerHTML = '5.0';
            document.querySelector("#acc span").nextElementSibling.innerHTML = 'วินาที';
            model = "LR";
        } else {
            animationValue = 450;
            maxAnimationValue = 514;
            animationValue2 = 0.0; // เริ่มค่า animationValue2 ที่ 0.0 สำหรับ 'LR'
            maxAnimationValue2 = 3.7;
            document.querySelector("#range span").innerHTML = '514';
            document.querySelector("#top_speed span").innerHTML = '250';
            document.querySelector("#acc span").innerHTML = '3.7';
            document.querySelector("#acc span").nextElementSibling.innerHTML = 'วินาที';
            model = "PFM";
        }
        price();
...
<script>
    ...
    function changepic(n) {
        ...
        const pic = "mdy" + "-" + car_colors[car_color] + "-" + car_wheel[wheel_Size] + "-" + car_interiors[car_interior]
        ...
        // console.log(k)
        path = "image/" + "ModelY/" + car_color + "/" + pic + "-" + k + ".jpg"

        document.getElementById("image").src = path
        path1 = "image/" + "ModelY/" + car_color + "/" + pic + "-1" + ".jpg"
        document.getElementById("image1").src = path1
        path2 = "image/" + "ModelY/" + car_color + "/" + pic + "-2" + ".jpg"
        document.getElementById("image2").src = path2
        path3 = "image/" + "ModelY/" + car_color + "/" + pic + "-4" + ".jpg"
        document.getElementById("image4").src = path3
        path4 = "image/" + "ModelY/" + car_color + "/" + pic + "-5" + ".jpg"
        document.getElementById("image5").src = path4
