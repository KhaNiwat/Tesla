...
<nav>
  <div class="nav-container">
    ...
    <?php if (isset($_SESSION['admin_login'])) { ?>
      ...
      <a href="./Admin_TestDrive.php">ตรวจสอบทดลองขับ</a>
        <a href="./Admin_SecondHand.php">ตรวจสอบโพสต์</a>
